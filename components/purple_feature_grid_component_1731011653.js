    ...
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container">
                <p id="feature-1-description" class="flex-1 text-sm">Browse through an extensive range of toilet paper brands, styles, and sizes to find your perfect match.</p>
            </div>
        </div>
        ...
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container">
                    <h4 id="feature-2-title" class="flex-1 text-slate-50 font-medium">Bulk Savings</h4>
                </div>
            </div>
            <div class="flex" id="feature-2-description-container">
                <p id="feature-2-description" class="flex-1 text-sm">Enjoy significant discounts on bulk purchases, ensuring you never run out of this essential item.</p>
            </div>
        </div>
        ...
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container">
                <p id="feature-3-description" class="flex-1 text-sm">Discover environmentally conscious choices, including recycled and bamboo toilet paper alternatives.</p>
            </div>
        </div>
        ...
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container">
                <p id="feature-4-description" class="flex-1 text-sm">Set up recurring deliveries and never worry about restocking your bathroom again.</p>
            </div>
        </div>
        ...
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container">
                <p id="feature-5-description" class="flex-1 text-sm">Make informed decisions with honest feedback from fellow toilet paper enthusiasts.</p>
            </div>
        </div>
        ...
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container">
                    <h4 id="feature-6-title" class="flex-1 text-slate-50 font-medium">Speedy Delivery</h4>
                </div>
            </div>
            <div class="flex" id="feature-6-description-container">
                <p id="feature-6-description" class="flex-1 text-sm">Experience quick and reliable shipping, because when you need toilet paper, you need it fast.</p>
            </div>
        </div>
    </div>
</template>
